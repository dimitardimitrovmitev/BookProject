      ...
      <div class="modal">
        ...
        <div style="display:flex;flex-direction:column;gap:16px">
          ...
          <div class="form-group">
            ...
            <textarea v-model="form.reviewText" class="form-textarea" placeholder="Share your thoughts…" style="min-height:140px" />
...
watch(() => props.show, v => {
  if (v) {
    errors.value = {}
    form.value = props.review ? { rating: props.review.rating, reviewText: props.review.reviewText } : { rating: 0, reviewText: '' }
  }
})
