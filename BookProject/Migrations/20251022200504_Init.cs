    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterReviews", x => x.CharacterReviewId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageGenerations", x => x.ImageGenerationId);
                    table.ForeignKey(
                        name: "FK_ImageGenerations_Scenes_SceneId",
                        column: x => x.SceneId,
